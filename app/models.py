...
class User(db.Model):
    ...
    num_post = db.Column(db.Integer, unsigned=True)
    num_reply = db.Column(db.Integer, unsigned=True)
    num_water = db.Column(db.Integer, unsigned=True)
    num_sign = db.Column(db.Integer, unsigned=True)
